<template>
  ...
  <button style="height: 40px; width: 40px" class="bg-gray-100 rounded-full fixed bottom-10 text-lg grid place-items-center left-3 text-slate-600 z-50" @click="control">
